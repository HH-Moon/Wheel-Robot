...
def go_straight():
    ...
    if adc_average > 700:
        ...
        up.CDS_SetSpeed(2, 800)  #左轮正转
    else:
        up.CDS_SetSpeed(1, 400)  # 右轮正转
        up.CDS_SetSpeed(2, 500)  # 左轮正转

def turn_left():
    up.CDS_SetSpeed(1, -800)       #右轮反转 -450
    up.CDS_SetSpeed(2, 800)  #左轮正转  450

def turn_right():
    up.CDS_SetSpeed(1, 800)  #右轮正转  450
    up.CDS_SetSpeed(2, -800)       #左轮反转 -450
...
def down_platform_detect():
    ...
    if io_data[1] == 0 and io_data[2] == 0:
        up.CDS_SetSpeed(1, 0)
        up.CDS_SetSpeed(2, 0)
        up.CDS_SetAngle(3, 599, 712)
        up.CDS_SetAngle(4, 488, 712)
        time.sleep(0.5)
        down_platform_act()
...
def down_platform_act():
    ...
    time.sleep(0.5)
    up.CDS_SetAngle(3, 372, 512)  #3号 底下704 上面372 平地599
    up.CDS_SetAngle(4, 715, 512)  #4号 底下395 上面715 平地488
    time.sleep(0.3)
    up.CDS_SetAngle(3, 704, 712)
    up.CDS_SetAngle(4, 395, 712)
    time.sleep(0.5)
